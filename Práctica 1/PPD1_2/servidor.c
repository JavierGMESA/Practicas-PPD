...
int main(){
	...
	strcpy(mensaje, "Hola guapo");
	write(confirmacion, mensaje, strlen(mensaje));				//Escribimos usando el mismo socket que hemos creado para comunicarnos con el cliente.
