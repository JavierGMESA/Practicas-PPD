...
int main () {
    ...
    {
        #pragma omp sections        //sections define partes de código que solo pueden ser ejecutadas por uno de los thread
        {
            #pragma omp section     //Esta sección solo la podrá ejecutar un thread (a priori el primero que llegue)
            {
